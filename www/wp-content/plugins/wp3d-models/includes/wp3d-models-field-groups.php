		...
		register_field_group(array (
			...
			'fields' => array (
				...
				array (
					...
					'type' => 'select',
					'instructions' => __('<img src="'.plugins_url().'/wp3d-models/assets/images/question-mark.png" class="alignleft wp3d-help" id="basevideotypehelp" alt="Use a YouTube or Vimeo video as the base content for your Model." data-hasqtip="0" aria-describedby="qtip-0"> <span class="wp3d-help-text">What is "Base Video Type"?</span>', 'wp3d-models'),				
					'choices' => array (
						'youtube' => 'YouTube',
						'vimeo' => 'Vimeo',
					),
                ...
                array (
                    ...
                    'instructions' => __('<a href="'.esc_url(plugins_url().'/wp3d-models/includes/wp3d-models-get-zip.php?mid=' . WP3D_Models::getMpID($_GET['post'])) . '" onclick="return confirm(\'Generate ZIP download from Matterport?\')">Get ZIP file from Matterport</a> - Use this link to download the full ZIP file for your model from Matterport.  These are large files and you may need to extend the default PHP timeout set with the host (heavy files)<br>
<a class="wp3d_post_link" data-post_id="'.$_GET['post'].'" href="'.esc_url('https://developers.facebook.com/tools/debug/sharing/?q=wp3d_post_url').'" target="_blank">Facebook Debugger</a> - This is where you come to refresh the cache (i.e.  re-scrape) the info from WP3D to showcase in Facebook.  Simply click the link in Facebook to “Fetch New Information”)', 'wp3d-models'),
                ),
				array (
				...
				array (
					...
					'type' => 'repeater',
					'instructions' => __('<img src="'.plugins_url().'/wp3d-models/assets/images/question-mark.png" class="alignleft wp3d-help" id="propertyinfohelp" alt="<b>EASTER EGG!</b><br><br>Advanced users, you can prepend any icon from the <a href=\'http://fontawesome.io/cheatsheet/\' target=\'_blank\'>Font Awesome Icon Library (opens in a new window)</a>.<br><br>For best results, begin your \'Title\' field with a \'fixed width\' fa tag, as seen on the <a href=\'http://fontawesome.io/examples/\' target=\'_blank\'>FontAwesome Example Page</a>." data-hasqtip="0" aria-describedby="qtip-0">Enter as many, or as few, details (Title + Value) as you like and drag/drop to re-order.', 'wp3d-models'),
					'conditional_logic' => array (
						'status' => 1,
						'rules' => array (
							array (
	...
	<img src="'.plugins_url().'/wp3d-models/assets/images/question-mark.png" class="alignleft wp3d-help" id="playbuttononlyhelp" alt="This option can be used if you have a unique embedding situation with limited (vertical) space. This is a bit of a fringe situation, but this should make some of you CHEER!" data-hasqtip="0" aria-describedby="qtip-0"> <span class="wp3d-help-text">Show only the PLAY BUTTON icon in Fullscreen & Embedded views.</span>				
				...
				array (
					...
					'type' => 'select',
					'choices' => array (
						'matterport_contact' => __('Use contact information from Matterport', 'wp3d-models'),
						'add_associated_agents' => __('Add associated Agents', 'wp3d-models'),
						'none' => __('Do not display contact information', 'wp3d-models'),
					),
					'conditional_logic' => array (
						'status' => 1,
						'rules' => array (
				...
				// Non-Matterport
				array (
					'key' => 'field_55918b7fa52c02',
					'label' => __('Contact/Agent Information', 'wp3d-models'),
					'name' => 'model_contact_information',
					'type' => 'select',
					'choices' => array (
						'add_associated_agents' => __('Add associated agents (with photos)', 'wp3d-models'),
					),
					'conditional_logic' => array (
						'status' => 1,
						'rules' => array (
				...
				// Is Matterport
				array (
					'key' => 'field_560c4be508b40',
					'label' => 'Associated Agents',
					'name' => 'associated_agents',
					'type' => 'relationship',
					'conditional_logic' => array (
						'status' => 1,
						'rules' => array (
							...
							array (
								'field' => 'field_5600deee5e803',
								'operator' => '==',
								'value' => 'add_associated_agents',
							),
						),
						'allorany' => 'all',
					),
				...
				// FOR MATTERPORT ONLY
				array (
					'key' => 'field_562d185f01029',
					'label' => __('Address Information', 'wp3d-models'),
					'name' => 'model_address_source',
					'type' => 'select',
					'instructions' => 'Choose how you would like this Model to be mapped',
					'choices' => array (
						'no_address' => 'Do not map this Model',
						'matterport_address' => 'Look for address information already saved with your Matterport Showcase',
						'custom_address' => 'Set custom address information',
					),
					'conditional_logic' => array (
						'status' => 1,
						'rules' => array (
					...
					'default_value' => $has_address_check, // uses function above to set default
					'allow_null' => 0,
					'multiple' => 0,
				),
				...
				// Additional Google Maps "Model Location" for non-Matterport 
				array (
