	...
	*/
	...
	public function generate_tools_message() {
		...
		<div style=\"margin-top: 10px; padding: 40px; border: 1px solid #CCCCCC;\">
			...
			<p>&lt;div id='wp3d-".get_the_ID()."'&gt;&lt;a href='".esc_url(trailingslashit(get_permalink()).'fullscreen/?embedded')."'&gt;LOADING - ".get_the_title()."&lt;/a&gt;&lt;script src='//s3-us-west-2.amazonaws.com/wp3dmodels/js/embed-iframe.js?id=wp3d-".get_the_ID()."'&gt;&lt;/script&gt;&lt;/div&gt;</p>
	        ...
	        <p>&lt;div id='wp3d-".get_the_ID()."'&gt;&lt;a href='".esc_url(trailingslashit(get_permalink()).'fullscreen-nobrand/?embedded')."'&gt;LOADING - ".get_the_title()."&lt;/a&gt;&lt;script src='//s3-us-west-2.amazonaws.com/wp3dmodels/js/embed-iframe.js?id=wp3d-".get_the_ID()."'&gt;&lt;/script&gt;&lt;/div&gt;</p>
...
<div id="wp3d-tools-tabs">
        ...
        <div class="hidden wp-tab-panel" id="embed">
			<ul class="wp3d-tools-link-list">
            	<li><a href="#" onClick="prompt('BRANDED JAVASCRIPT EMBED CODE:', '<div id=\'wp3d-<?php echo get_the_ID(); ?>\'><a href=\'<?php echo esc_url(trailingslashit(get_permalink()).'fullscreen/?embedded'); ?>\'>LOADING - <?php echo get_the_title(); ?></a><script src=\'//s3-us-west-2.amazonaws.com/wp3dmodels/js/embed-iframe.js?id=wp3d-<?php echo get_the_ID(); ?>\'></script></div>'); return false;">Standard Fullscreen (JS)</a></li>
        ...
        <div class="hidden wp-tab-panel" id="misc">
            <ul class="wp3d-tools-link-list">
            	...
            	<li><a href="<?php echo esc_url(plugins_url().'/wp3d-models/includes/wp3d-models-get-zip.php?mid='.$mp_id); ?>" target="_blank" onClick="confirm('Generate ZIP download from Matterport?');">Download ZIP from Matterport</a>
            	<?php } ?>
	...
	if ( $GLOBALS['pagenow'] != 'wp-login.php' ) {
	    ...
	    (function($) {
			...
			<?php } else { 	// ACF FREE
				...
				if (function_exists( 'acf_get_setting' )) { $this_acf_version = acf_get_setting('version'); } 
	...
	*/
	...
	$plugins_url = plugins_url();		
		...
		if (get_option('wp3d_sold_image')) { //if there's a replacement "SOLD" image, update SRC
			...
			$sold_image_src = $plugins_url.'/wp3d-models/assets/images/wp3d-sold-banner.png';
		}
	...
	$plugins_url = plugins_url();		
		...
		if (get_option('wp3d_pending_image')) { //if there's a replacement "PENDING" image, update SRC
			...
			$pending_image_src = $plugins_url.'/wp3d-models/assets/images/wp3d-pending-banner.png';
		}
	...
	$plugins_url = plugins_url();		
		...
		if (get_option('wp3d_custom_status_image')) { //if there's a replacement "CUSTOM STATUS" image, update SRC
			...
			$custom_status_image_src = $plugins_url.'/wp3d-models/assets/images/wp3d-custom-status-banner.png';
		}
