...
foreach ($header_arr as $header_line) {
    ...
    if (strpos($header_line,'/wp-content/plugins/wp3d-models/') == true) { 
...
$footer_arr = explode("\n", $buffer);
    foreach ($footer_arr as $footer_line) {
        ...
        if (strpos($footer_line,'/wp-content/plugins/wp3d-models/assets/') == true || strpos($footer_line,'maps.googleapis.com') == true || strpos($footer_line,'slick.min') == true || strpos($footer_line,'swiper.jquery.min') == true  ) {
