...
define( 'WP3D_MODELS_VERSION', '3.5.4' );
...
define( 'WP3D_MODELS_PLUGIN_NAME', 'WP3D Models Plugin' ); 
define( 'WP3D_MODELS_MULTISITE_PLUGIN_NAME', 'WP3D Models Plugin (Multi-site)' );
...
WP3D_Models()->register_post_type( 'wp3d_agent', __( 'Agents', 'wp3d-models' ), __( 'Agent', 'wp3d-models' ), 'wp3d-agent');
